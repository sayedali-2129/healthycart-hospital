...
import '../../features/hospital_doctor/application/doctor_provider.dart'
    as _i27;
import '../../features/hospital_doctor/domain/i_doctor_facade.dart' as _i13;
...
import '../../features/hospital_profile/application/profile_provider.dart'
    as _i28;
import '../../features/hospital_profile/domain/i_profile_facade.dart' as _i19;
...
import '../../features/location_picker/infrastructure/i_location_impl.dart'
    as _i18;
import '../../features/pending_page/application/pending_provider.dart' as _i21;
import '../../features/pending_page/domain/i_pending_facade.dart' as _i11;
...
Future<_i1.GetIt> init(
  ...
  gh.lazySingleton<_i11.IPendingFacade>(
      () => _i12.IPendingImpl(gh<_i10.UrlService>()));
  gh.lazySingleton<_i13.IDoctorFacade>(() => _i14.IDoctorImpl(
        gh<_i6.FirebaseFirestore>(),
        gh<_i7.ImageService>(),
      ));
  gh.lazySingleton<_i15.IFormFeildFacade>(() => _i16.IFormFieldImpl(
        gh<_i6.FirebaseFirestore>(),
        gh<_i7.ImageService>(),
  ...
  gh.lazySingleton<_i19.IProfileFacade>(
      () => _i20.IProfileImpl(gh<_i6.FirebaseFirestore>()));
  gh.factory<_i21.PendingProvider>(
      () => _i21.PendingProvider(gh<_i11.IPendingFacade>()));
