          ...
          child: InkWell(
            onTap: () async {
              LoadingLottie.showLoading(
                  context: context, text: 'Adding Location..');
              await locationProvider.setLocationByHospital(context: context);
            },
            child: Padding(
              padding:
        ...
        if(locationProvider.searchLoading)
           const SliverToBoxAdapter(
            child: Padding(
              ...
              child: LinearProgressIndicator(color: BColors.darkblue,),
            )
          ),
